...
class Transformer(nn.Module):
    ...
    def forward(self, src, mask, query_embed_h, query_embed_o, pos_guided_embed, pos_embed):
        ...
        h_hs = self.sub_graphHead(h_hs.reshape(n_l*bs, n_q, n_d)).reshape(n_l, bs, n_q, n_d)
        o_hs = self.obj_graphHead(o_hs.reshape(n_l*bs, n_q, n_d)).reshape(n_l, bs, n_q, n_d)
