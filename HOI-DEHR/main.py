...
def get_args_parser():
    ...
    parser.add_argument('--hoi_gpt', action='store_true')
    parser.add_argument('--obj_gpt', action='store_true')
...
def main(args):
    ...
    # data_loader_train = DataLoader(dataset_train, args.batch_size, collate_fn=utils.collate_fn, num_workers=args.num_workers)
    # data_loader_val = DataLoader(dataset_val, args.batch_size, drop_last=False, collate_fn=utils.collate_fn, num_workers=args.num_workers)
