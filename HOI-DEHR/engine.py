...
def train_one_epoch(model: torch.nn.Module, vlm, criterion: torch.nn.Module,
    ...
    for samples, targets in metric_logger.log_every(data_loader, print_freq, header):
        ...
        outputs = model(samples, vlm, clip_input=clip_img)
        # print(targets)
...
@torch.no_grad()
def evaluate_hoi(dataset_file, model, vlm, postprocessors, data_loader,
    ...
    for samples, targets in metric_logger.log_every(data_loader, 100, header):
        ...
        # print(targets)
        outputs = model(samples, vlm, is_training=False, clip_input=clip_img)
