...
class VCOCO(torch.utils.data.Dataset):
    ...
    def __init__(self, vis_processors, img_set, img_folder, anno_file, transforms, num_queries, args):
...
def build(vis_processors, image_set, args):
    ...
    dataset = VCOCO(vis_processors, image_set, img_folder, anno_file, transforms=make_vcoco_transforms(image_set),
