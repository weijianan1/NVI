...
class HICODetection(torch.utils.data.Dataset):
    def __init__(self, vis_processors, img_set, img_folder, anno_file, clip_feats_folder, transforms, num_queries, args):
    ...
    def __getitem__(self, idx):
        ...
        if self.img_set == 'train':
            ...
            clip_inputs = self.vis_processors['eval'](img_0)
...
def build(vis_processors, image_set, args):
    ...
    dataset = HICODetection(vis_processors, image_set, img_folder, anno_file, clip_feats_folder,
